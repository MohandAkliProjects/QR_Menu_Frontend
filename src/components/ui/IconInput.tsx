...
function IconInput({ icon: Icon, type = "text", placeholder, value, onChange, error }: IconInputProps) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      `}>
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className="flex-1 bg-transparent text-base text-dark-700 placeholder:text-text-400 focus:outline-none"
        />
      </div>

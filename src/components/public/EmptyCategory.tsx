...
/** Mirrors the Figma `EmptyCategory`, with a configurable message. */
function EmptyCategory({ message = "No dishes available in this category." }: EmptyCategoryProps) {
  return (
    <div className="flex flex-col items-center py-16 px-8 text-center">
      ...
      <p className="text-xs text-[var(--menu-muted)]/70 mt-1">

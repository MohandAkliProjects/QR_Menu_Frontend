...
/**
 * Replaces the old `DishModal`. Dropped vs. the Figma `ItemModal`:
 * - image gallery / swipe between multiple photos (`DishResponse` only
 *   has a single `imageUrl`)
 * - prep time, calories, ingredients, allergens, rating (not in
 *   `DishResponse` yet) - re-add these sections once the backend
 *   exposes them, the layout below has natural slots for each.
 */
